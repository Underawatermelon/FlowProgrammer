...
class TransformObsImg:
    ...
    def __init__(self, cfg) -> None:
        ...
        self.axial_flip = cfg.data_cfg.x_axial_flip
        self.randinv = cfg.data_cfg.x_randinv
        self.randaxtl = cfg.data_cfg.x_rand_axial_translate
        self.compeye = cfg.data_cfg.compeye
    ...
    def __call__(self, img, sym_trigger=False):
